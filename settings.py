...
# CW & GUILD DATA
CW_BOT_ID=408101137
GUILD_NAME=b'\\U0001f954[<short-guild-name>]'
BATTLES=["07:00UTC", "15:00UTC", "23:00UTC"]

# MESSAGES
MESSAGES={
          "start": u'Welcome <b>{0}</b>!\n\nUse /help for more details',
          "help": u'Hi <b>{0}</b>! Are you having trouble?\n\nFeel free to contact with my creator (@Toni_SM) if you have any question or feedback.\n\nBest regards\nMe (the bot)',
